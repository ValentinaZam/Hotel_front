        ...
        <div className='header__container'>
            ...
            <div >
                ...
                <div className='header__nav'>
                    <NavLink className={location.pathname === "/rooms" ? "header__link_active" : "header__link_not-active"}
                        to="/rooms">Номерной фонд</NavLink>
                    <NavLink className={location.pathname === "/saved-rooms" ? "header__button-active" : "header__link_not-active"}
